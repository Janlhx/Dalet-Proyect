...
## Corpus Check
- 68 files · ~138,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 739 nodes · 1223 edges · 50 communities (45 shown, 5 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `114958e5`
...
### Community 10 - "dalet_osuanalyzer.py"
Cohesion: 0.50
Nodes (3): Módulo de Lógica de Análisis de osu! (v4.1) Esta versión corrige el 'edge case'…, Función 'setup' vacía (este módulo no es un Cog)., setup()
...
- **Why does `DaletAtoms` connect `DaletAtoms` to `OsuHandler`, `SlashCommands`, `DaletReminders`, `AIConfigCommands`, `.get_rank_color`, `OsuPresenter`, `CategorySelect`, `CommandsHandler`, `HelpPaginator`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **Why does `DaletReminders` connect `DaletReminders` to `TursoClient`, `ReminderRepository`, `DaletAtoms`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `OsuAnalyzer` connect `OsuAnalyzer` to `OsuHandler`, `SlashCommands`, `dalet_main.py`, `dalet_osuanalyzer.py`, `DaletAtoms`?**
