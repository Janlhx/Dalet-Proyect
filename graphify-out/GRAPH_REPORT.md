...
## Corpus Check
- 72 files · ~139,752 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 762 nodes · 1281 edges · 51 communities (43 shown, 8 thin omitted)
...
Cohesion: 0.11
Nodes (12): Color, _get_country_flag(), Construye la tarjeta de perfil osu! limpia y estructurada., Convierte un código ISO de país (ej. 'CO', 'US') en su emoji de bandera., Devuelve el color correspondiente al grade de osu!., Devuelve un color de acento basado en el rango global numérico., Embed, Añade el footer minimalista y característico de Dalet. (+4 more)
...
Cohesion: 0.11
Nodes (16): api_telemetry(), health(), home(), privacy(), Sirve la interfaz web del Dashboard de telemetría., Devuelve métricas en tiempo real en formato JSON., Health check simple para Render., Términos de servicio para verificación en Discord. (+8 more)
...
Cohesion: 0.08
Nodes (14): AdminRepository, Activa o desactiva el bloqueo de comandos en un canal., Obtiene el nombre personalizado del bot para un servidor., Establece un nombre personalizado para el bot en un servidor., Obtiene el ID del canal de bienvenida de un servidor., Establece o elimina el canal de bienvenida para un servidor., Verifica si los comandos están bloqueados en un canal., Obtiene el idioma configurado para el servidor ('en' o 'es'). Predeterminado… (+6 more)
...
Cohesion: 0.16
Nodes (11): Connection, keep_alive(), load_extensions(), main(), run_flask(), AnalyticsRepository, Repositorio para escritura de datos analíticos: CommandUsage, AIInteractions,…, Calcula estadísticas agregadas desde SQLite. (+3 more)

### Community 39 - ".fetch_all"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (21): Any, _format_acc(), _format_mods(), _mode_title(), OsuPresenter, Embed, Construye un Embed estructurado con los Top Plays del usuario., Formatea la precisión (0.0 a 1.0) a porcentaje XX.XX%. (+13 more)
...
- **Why does `DaletAtoms` connect `DaletAtoms` to `OsuHandler`, `SlashCommands`, `DaletReminders`, `AdminCommands`, `AIConfigCommands`, `OsuPresenter`, `EventsHandler`, `.add_standard_footer`, `CommandsHandler`, `HelpPaginator`, `TursoClient`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `SQLiteManager` connect `dalet_main.py` to `AdminCommands`, `.fetch_all`, `UserRepository`, `DaletAtoms`, `DashboardService`, `.execute`, `TursoClient`?**
